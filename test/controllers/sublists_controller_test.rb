...
class SublistsControllerTest < ActionController::TestCase
  ...
  test "should create sublist" do
    assert_difference('Sublist.count') do
      post :create, sublist: { adress: @sublist.adress, description: @sublist.description, title: @sublist.title }
    end
  ...
  test "should update sublist" do
    patch :update, id: @sublist, sublist: { adress: @sublist.adress, description: @sublist.description, title: @sublist.title }
    assert_redirected_to sublist_path(assigns(:sublist))
  end
